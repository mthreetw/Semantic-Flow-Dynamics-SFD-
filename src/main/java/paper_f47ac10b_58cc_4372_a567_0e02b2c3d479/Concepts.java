...
public class Concepts {
    ...
    // ========================================================
    // 包裹上游概念（單一 field，field 名稱固定為「上游」）
    // 完整繼承 paper_40a22ff8_9d90_4e1e_82f6_1fd80917c139.Concepts
    // 中的全部 42 個 record，不得遺漏（Java 手冊 §2.1 完整繼承規則）
    // ========================================================
    ...
    // ========================================================
    // 本篇原生概念（空 record）
    // 對應形式化文件「概念摘要」中列出的 17 個本篇 exports
    // ========================================================

    public record 信模() {}
    public record 核心信的判準() {}
    public record 認同構成() {}
    public record 死亡判準() {}
    public record 英雄() {}
    public record 衣服() {}
